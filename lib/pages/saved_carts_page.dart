...
class _SavedCartsPageState extends State<SavedCartsPage> {
  ...
  bool _filterCart(DateTime cartDate) {
    ...
    if (_filterType == 'Day') {
      ...
      final firstDayOfWeek = _selectedDate!.subtract(Duration(days: weekDay - 1));
      final lastDayOfWeek = firstDayOfWeek.add(const Duration(days: 6));
      return cartDate.isAfter(firstDayOfWeek.subtract(const Duration(days: 1))) &&
  ...
  Widget _buildTotals(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Text('Total Selling Price: ${formatter.format(totalPrice)} L.L',
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Theme.of(context).primaryColor)),
          const SizedBox(height: 6),
          Text('Total Origin Price (Cost): ${formatter.format(totalOrigin)} L.L',
              style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
          const SizedBox(height: 6),
          Text('Total Profit: ${formatter.format(totalProfit)} L.L',
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Theme.of(context).primaryColor)),
        ],
      ),
    );
          ...
          children: [
            ...
            Expanded(
              child: filteredCarts.isEmpty
                  ? const Center(child: Text('No saved carts for the selected filter.'))
                  : ListView.builder(
                        ...
                        return Card(
                          ...
                          child: ExpansionTile(
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                Text('Selling: ${formatter.format(totalPrice)} L.L'),
                                Text('Cost: ${formatter.format(totalOrigin)} L.L'),
                                Text('Profit: ${formatter.format(totalProfit)} L.L',
                                    style: TextStyle(fontWeight: FontWeight.bold, color: Theme.of(context).primaryColor)),
                              ],
                            ),
                            children: [
                              ...items.map((item) => ListTile(
                                    ...
                                    subtitle: Column(
                                      ...
                                      children: [
                                        ...
                                        Text('Selling Price: ${formatter.format(item.price)} L.L'),
